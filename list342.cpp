...
int main()
{
	...
	/*List342<Child> build_test;
	build_test.BuildList("BuildTest_test.txt");
	cout << "build_test: " << build_test << endl;
	List342<int> numbers1;
	int num = 1;
	int num2 = 2;
	int num3 = -14;
	int num4 = 1000;
	...
	//int item;
	numbers1.Insert(&num);
	numbers1.Insert(&num2);
	numbers1.Insert(&num3);
	numbers1.Insert(&num4);
	cout << numbers1 << endl;

	List342<int> new_numbers;
	new_numbers.Insert(&num6);
	new_numbers.Insert(&num7);
	new_numbers.Insert(&num8);
	cout << new_numbers << endl;

	new_numbers.Merge(numbers1);
	cout << new_numbers << endl;*/
	return 0;
